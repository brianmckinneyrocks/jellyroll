...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.o_secret'
        db.add_column('jellyroll_photo', 'o_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.o_secret'
        db.delete_column('jellyroll_photo', 'o_secret')
    ...
    models = {
        ...
        'jellyroll.photo': {
            ...
            'local_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'o_secret': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
