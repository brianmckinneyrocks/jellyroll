...
class Location(models.Model):
  """
  A location is data about where you are currently located..
  """
  longitude = models.TextField()
  latitude = models.TextField()
  display_location = models.TextField()
  ...
  def get_absolute_url(self):
    ...
    d = self.date_published.strftime("%d").lower()
    i = str(self.id)
    return ('locations_detail', (), {'year': y, 'month': m, 'day': d, 'object_id': i})
...
Item.objects.follow_model(Status)
